...
def crawl_web(seed):  # returns index, graph of inlinks
    ...
    while tocrawl:
        ...
        if page not in crawled:
            content = get_page(page)#网站内容
            add_page_to_index(index, page, content)#添加关键词{keyword,[url,url,url....],......}
            outlinks = get_all_links(content)#指向外部的连接

            graph[page] = outlinks#{url,[outlink,outlink.....],......}
